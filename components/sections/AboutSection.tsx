        ...
        <AnimateIn direction="right" delay={150} className={styles.introCol}>
          <div className={styles.textCol}>
            ...
            <p className={styles.para}>
              Make Up Artist spesialis riasan <strong>timeless &amp; natural</strong> yang telah berkecimpung di dunia makeup sejak 2018 (usia 18 tahun). Selain sebagai MUA, juga berperan sebagai <strong>konsultan wedding &amp; fashion brides.</strong>
            </p>
            <p className={styles.para}>
