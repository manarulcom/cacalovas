...
const CITY_AREA = 'Banjarnegara, Kebumen, Purbalingga';
const WA = `https://wa.me/6285166662347?text=${encodeURIComponent(`Halo Cacalovas, saya di Banjarnegara ingin booking makeup`)}`;

const services = [
  { title: 'Make Up Only', desc: 'Graduation, Party & Photoshoot di Banjarnegara', icon: '✨', gradient: 'linear-gradient(135deg,#F2C4B3,#D89880)', textColor: '#3D2420', iconBg: 'rgba(255,255,255,0.4)' },
  { title: 'Engagement / Lamaran', desc: 'Riasan eksklusif untuk momen pertunangan di Banjarnegara', icon: '💍', gradient: 'linear-gradient(135deg,#4A302B,#251613)', textColor: '#FFFFFF', iconBg: 'rgba(255,255,255,0.1)' },
  { title: 'Wedding Package', desc: 'Paket riasan pengantin komprehensif di Banjarnegara', icon: '👑', gradient: 'linear-gradient(135deg,#E6C181,#B88E45)', textColor: '#2A1A0B', iconBg: 'rgba(255,255,255,0.35)' },
];

const faqs = [
  { q: 'Berapa harga MUA di Banjarnegara?', a: 'Harga MUA Cacalovas di Banjarnegara mulai dari Rp 850.000 untuk siraman/engagement, hingga Rp 1.500.000 untuk paket akad & resepsi. Hubungi via WhatsApp untuk konsultasi gratis.' },
  { q: 'Apakah Cacalovas MUA Banjarnegara bisa ke lokasi?', a: 'Ya! Kami melayani seluruh area Banjarnegara dan sekitarnya termasuk Kebumen dan Purbalingga. Biaya transport berlaku untuk lokasi yang jauh dari area utama kami.' },
  { q: 'Apakah ada MUA wisuda Banjarnegara di Cacalovas?', a: 'Tentu! Cacalovas melayani riasan wisuda di Banjarnegara dengan hasil fotogenik dan tahan lama. Booking minimal 2 minggu sebelum hari wisuda.' },
  { q: 'Berapa lama proses riasan MUA Banjarnegara?', a: 'Rata-rata 1.5–2.5 jam tergantung kompleksitas riasan. Untuk pernikahan, disarankan mulai lebih pagi agar tidak terburu-buru.' },
...
export default function MUABanjarnegaraPage() {
  ...
  const jsonLd = {
    ...
    geo: { '@type': 'GeoCoordinates', latitude: -7.3912, longitude: 109.6918 },
    areaServed: [{ '@type': 'City', name: 'Banjarnegara' }, { '@type': 'City', name: 'Banyumas' }],
      ...
      <main>
        ...
        <section style={{ background: '#FDF5F0', padding: '9rem 1.5rem 5rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', maxWidth: 680, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href={WA} target="_blank" rel="noopener noreferrer" id="mua-banjarnegara-hero-wa"
        ...
        <section style={{ background: '#fff', padding: '5rem 1.5rem' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            ...
            <div style={{ borderRadius: 20, overflow: 'hidden', border: '1px solid #EDD5CB' }}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.3071785097463!2d109.82582049999999!3d-7.205753299999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e700fe421d06a6b%3A0x3b588001310433dd!2sCacalovas!5e0!3m2!1sid!2sid!4v1778715647482!5m2!1sid!2sid"
                width="100%" height="360" style={{ border: 0, display: 'block' }}
                allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"
                title={`Peta Lokasi Studio Utama Cacalovas di Banjarnegara`}
              />
            </div>
          </div>
        </section>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {faqs.map((f, i) => (
                <div key={i} style={{ background: '#fff', borderRadius: 14, border: '1px solid #EDD5CB', overflow: 'hidden' }}>
                  <button onClick={() => setOpenFaq(openFaq === i ? null : i)} id={`faq-banjarnegara-${i}`}
        ...
        <section style={{ background: '#3D2420', padding: '5rem 1.5rem', textAlign: 'center' }}>
          <div style={{ maxWidth: 600, margin: '0 auto' }}>
            ...
            <a href={WA} target="_blank" rel="noopener noreferrer" id="mua-banjarnegara-cta"
