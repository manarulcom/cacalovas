...
const CITY_AREA = 'Purwokerto, Banyumas, Cilacap';
const WA = `https://wa.me/6285166662347?text=${encodeURIComponent(`Halo Cacalovas, saya di Purwokerto ingin booking makeup`)}`;

const services = [
  { title: 'Make Up Only', desc: 'Graduation, Party & Photoshoot di Purwokerto', icon: '✨', gradient: 'linear-gradient(135deg,#F2C4B3,#D89880)', textColor: '#3D2420', iconBg: 'rgba(255,255,255,0.4)' },
  { title: 'Engagement / Lamaran', desc: 'Riasan eksklusif untuk momen pertunangan di Purwokerto', icon: '💍', gradient: 'linear-gradient(135deg,#4A302B,#251613)', textColor: '#FFFFFF', iconBg: 'rgba(255,255,255,0.1)' },
  { title: 'Wedding Package', desc: 'Paket riasan pengantin komprehensif di Purwokerto', icon: '👑', gradient: 'linear-gradient(135deg,#E6C181,#B88E45)', textColor: '#2A1A0B', iconBg: 'rgba(255,255,255,0.35)' },
];

const faqs = [
  { q: 'Berapa harga MUA di Purwokerto?', a: 'Harga MUA Cacalovas di Purwokerto mulai dari Rp 850.000 untuk siraman/engagement, hingga Rp 1.500.000 untuk paket akad & resepsi. Hubungi via WhatsApp untuk konsultasi gratis.' },
  { q: 'Apakah Cacalovas MUA Purwokerto bisa ke lokasi?', a: 'Ya! Kami melayani seluruh area Purwokerto dan sekitarnya termasuk Banyumas, Cilacap. Biaya transport berlaku untuk lokasi yang jauh dari area utama kami.' },
  { q: 'Apakah ada MUA wisuda Purwokerto di Cacalovas?', a: 'Tentu! Cacalovas melayani riasan wisuda di Purwokerto dengan hasil fotogenik dan tahan lama. Booking minimal 2 minggu sebelum hari wisuda.' },
  { q: 'Berapa lama proses riasan MUA Purwokerto?', a: 'Rata-rata 1.5–2.5 jam tergantung kompleksitas riasan. Untuk pernikahan, disarankan mulai lebih pagi agar tidak terburu-buru.' },
...
export default function MUAPurwokertoPage() {
  ...
  const jsonLd = {
    ...
    geo: { '@type': 'GeoCoordinates', latitude: -7.4313, longitude: 109.2481 },
    areaServed: [{ '@type': 'City', name: 'Purwokerto' }, { '@type': 'City', name: 'Banyumas' }],
      ...
      <main>
        ...
        <section style={{ background: '#FDF5F0', padding: '9rem 1.5rem 5rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', maxWidth: 680, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href={WA} target="_blank" rel="noopener noreferrer" id="mua-purwokerto-hero-wa"
        ...
        <section style={{ background: '#fff', padding: '5rem 1.5rem' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            ...
            <div style={{ borderRadius: 20, overflow: 'hidden', border: '1px solid #EDD5CB' }}>
              <iframe
                src="https://maps.google.com/maps?q=Purwokerto,+Central+Java&t=&z=11&ie=UTF8&iwloc=&output=embed"
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {faqs.map((f, i) => (
                <div key={i} style={{ background: '#fff', borderRadius: 14, border: '1px solid #EDD5CB', overflow: 'hidden' }}>
                  <button onClick={() => setOpenFaq(openFaq === i ? null : i)} id={`faq-purwokerto-${i}`}
        ...
        <section style={{ background: '#3D2420', padding: '5rem 1.5rem', textAlign: 'center' }}>
          <div style={{ maxWidth: 600, margin: '0 auto' }}>
            ...
            <a href={WA} target="_blank" rel="noopener noreferrer" id="mua-purwokerto-cta"
